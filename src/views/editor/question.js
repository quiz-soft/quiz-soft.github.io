...
export function createQuestion(question, index) {
    ...
    function onDelete() {
        const confirmed = confirm('Are you sure you want to delet this question?');
        if (confirmed) {
            element.remove();
        }
    }
    ...
    async function onSave() {
        const formData = new FormData(element.querySelector('form'));//хващаме формата през елемента
